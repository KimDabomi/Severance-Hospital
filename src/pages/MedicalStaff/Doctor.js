        ...
        <MapArticle position={bgPosition}>
          ...
          <map name="image-map1">
            ...
            <area
              ...
              onClick={() => setBgPosition(0)} // 이미지 클릭 시, 해당 이미지의 포지션 값 셋팅
            />
